-- Adiciona Melhorias como 5ª tarefa da chama: conta como cumprida no dia se
-- houver pelo menos 2 melhorias criadas naquele dia (uma só não conta).
-- Continua exigindo "pelo menos 3" no total.
